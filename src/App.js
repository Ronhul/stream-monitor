...
function App() {
  ...
  // Calculate the grid layout based on the number of streams
  const getGridTemplateAreas = () => {
    switch (streams.length) {
      case 0:
        return '"add add add"';
      case 1:
        return '"s0 s0 s0" "add add add"';
      case 2:
        return '"s0 s0 s1" "add add add"';
      case 3:
        return '"s0 s0 s1" "s0 s0 s2" "add add add"';
      case 4:
        return '"s0 s0 s1" "s0 s0 s2" "s3 s3 add"';
      case 5:
        return '"s0 s0 s1" "s0 s0 s2" "s3 s4 add"';
      case 6:
        return '"s0 s0 s1" "s0 s0 s2" "s3 s4 s5" "add add add"';
      case 7:
        return '"s0 s0 s1" "s0 s0 s2" "s3 s4 s5" "s6 add add"';
      case 8:
        return '"s0 s0 s1" "s0 s0 s2" "s3 s4 s5" "s6 s7 add"';
      default:
        return '';
    }
  };
